<?php
    ...
    $sql = "SELECT 
                ...
                reportes.id as id,
                reportes.id_usuario as id_user,
            ...
            FROM
                t_reportes AS reportes
                    INNER JOIN
                t_torres AS torres ON reportes.id_torre = torres.id 
                ";
            ...
            <table class="table table-hover table-dark table-reponsive" id="tablaGestorDataTable">
                ...
                <?php
                    ...
                    while ($mostrar = mysqli_fetch_array($result)){
                        ...
                        $idReporte = $mostrar['id'];
                        $user = $mostrar['id_user'];
                ?>

                    <tr>
                        <td style="text-align: center;"><?php
                        $conexionU = $c->Conexion();
                        $sqlU="SELECT id, nombre FROM t_usuarios WHERE id = '$user'";
                        ...
                        <td> <span class="btn btn-danger btn-sm" onclick="eliminarReporte('<?php echo $idReporte; ?>')"> <span class="fas fa-trash-alt"></span> </span></td>
